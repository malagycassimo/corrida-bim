  ...
  return (
    <div className="mt-8">
      <div className="w-fit space-x-3 lg:space-x-5 mx-auto flex  mb-4">
        ...
        <Disabled active={active === "disabled"} setActive={setActive} />
      ...
      <div className="mx-auto max-w-[826px]">
        ...
        {active === "disabled" && <Map1 embedId="3283747075580661848" />}
...
const Disabled = ({
  ...
  return (
    ...
    >
      ...
      >
        <span className="md:inline-block hidden">Deficientes - 9km</span>
      </span>
    </button>
  );
};
